...
$classes = ($active ?? false)
            ...
            : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 dark:text-gray-100 hover:text-gray-800 dark:text-white hover:bg-gray-50 dark:bg-gray-800 hover:border-gray-300 focus:outline-none focus:text-gray-800 dark:text-white focus:bg-gray-50 dark:bg-gray-800 focus:border-gray-300 transition';
@endphp
