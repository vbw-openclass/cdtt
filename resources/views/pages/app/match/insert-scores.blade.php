    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="relative border overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <!-- TODO:L'équipe qui fait forfait à 0 et l'autre équipe à tous les points. Par exemple prompotion c'est du 3 contre 3 avec un match double, ça fait 10-0 -->
                <div class="p-6 text-center w-full text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    <button type="button" class="text-white w-64 bg-gradient-to-r  from-red-500 via-red-600 to-red-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Forfait équipe recevante</button>
                    <button type="button" class="text-white w-64 bg-gradient-to-r  from-red-500 via-red-600 to-red-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Forfait équipe visiteuse</button>
                </div>
            </div>
        </div>
      </section>
